...
export const classModalBtns = `mt-10 ${classCenterChildDiv} modal-btns`;
...
export const classListContent = 'px-2 py-2 whitespace-nowrap font-medium text-wrap';
...
export const classTab = 'px-1 sm:px-5 h-screen';
