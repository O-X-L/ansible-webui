...
ES = {
    ...
    'logs.exec_canceled': 'Ejecución cancelada!',
    ...
    'config.form.help.ansible_executor': '¿Qué biblioteca se utiliza para ejecutar Ansible?  Puedes elegir entre el '
