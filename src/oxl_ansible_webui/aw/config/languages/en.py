...
EN = {
    ...
    'logs.exec_canceled': 'Execution canceled!',
    ...
    'config.form.help.ansible_executor': 'What library is used to execute Ansible. You can choose between the official '
