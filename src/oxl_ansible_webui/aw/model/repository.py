...
class Repository(BaseModel):
    ...
    git_hook_pre = models.TextField(max_length=1000, **DEFAULT_NONE)
    git_hook_post = models.TextField(max_length=1000, **DEFAULT_NONE)
    git_hook_cleanup = models.TextField(max_length=1000, **DEFAULT_NONE)
    git_override_initialize = models.TextField(max_length=1000, **DEFAULT_NONE)
    git_override_update = models.TextField(max_length=1000, **DEFAULT_NONE)
    git_playbook_base = models.TextField(max_length=300, **DEFAULT_NONE)
